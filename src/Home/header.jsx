      ...
      {isScrolled ? (
            <header onClick={handleScrollToTop} className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center bg-[#ffffff] md:py-2 border-b border-opacity-30">
                ...
                <div className="flex items-center">
                  <div className="flex items-center max-w-screen-xl justify-between mx-auto w-full">
                    ...
                    <ul className="md:flex hidden items-center w-full justify-end mx-auto">
                      ...
                      <li>
                        <a href="./online-consulting" className="items-center text-sm tracking-wider relative h-8 pt-0.5 duration-200 px-4 flex justify-center flex-row hover:text-[#1A2B6B] text-[#000]">
                          Online Consulting
                        </a>
                      </li>
                      <div className='flex'>
              ...
              >
                ...
                <li>
                  <a href="./online-consulting" className="tracking-wider border-b border-opacity-30 px-8 py-3 flex flex-row items-center duration-200 hover:text-[#1A2B6B] text-[#000] border-[#403f68] text-sm leading-normal">
                    Online Consulting
                  </a>
                  <div className='border-b border-[#fff] border-opacity-30 mx-3'/>
                </li>
