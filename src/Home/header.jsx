    ...
    >
      <div className="mx-auto max-w-screen-xl px-4 md:px-10 flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-6 text-sm tracking-wide">
          <Link to="/" className="hover:text-[#1A2B6B]">Home</Link>
          <Link to="/about-us" className="hover:text-[#1A2B6B]">About Us</Link>
          ...
          >
            <button className="hover:text-[#1A2B6B] flex items-center gap-1">
              Our Businesses
          ...
          <Link to="/online-consulting" className="hover:text-[#1A2B6B]">Online Consulting</Link>
          <Link
            to="/contact-us"
            className="border border-[#0847F7] px-5 py-2 rounded-sm text-[#0847F7] hover:bg-[#0847F7] hover:text-white"
          >
            Contact Us
          </Link>
        </nav>
        ...
        {/* Mobile Menu Button */}
        <div
          className="md:hidden text-3xl z-10 text-[#000]"
